...
НЕ УДАЛЯЕТ сообщения участников!
"""
...
async def delete_bot_message(bot: Bot, chat_id: int, message_id: int, delay: int = 10):
...
# ============ ВАЖНО ============
# Этот модуль НЕ УДАЛЯЕТ сообщения участников!
# Только сообщения, отправленные САМИМ БОТОМ.
